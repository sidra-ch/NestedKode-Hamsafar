         ...
         <footer>
            <div className="tg-footer-area tg-footer-space include-bg" style={{ backgroundImage: `url(/assets/img/footer/footer.jpg)` }}>
                     ...
                     <div className="row">
                        <div className="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                           <div className="tg-footer-widget mb-40">
                              <div className="tg-footer-logo mb-20">
                                 <Link to="/" className="hamsafar-logo">
                                    HAM<span>SAFAR</span>
                                 </Link>
                              </div>
                              <p className="mb-20">Hamsafar is your trusted partner for tours, hotels, rentals and tickets worldwide.</p>
                        ...
                        <div className="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                           <div className="tg-footer-widget tg-footer-link ml-80 mb-40">
                              ...
                              <ul>
                                 ...
                                 <li><Link to="/tour-grid-2">Tours</Link></li>
                                 <li><Link to="/hotel-grid">Hotels</Link></li>
                                 <li><Link to="/map-listing">Rental</Link></li>
                                 <li><Link to="/checkout">Tickets</Link></li>
                              </ul>
                           </div>
                        </div>
                        <div className="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                        ...
                        <div className="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                           <div className="tg-footer-widget tg-footer-link mb-40">
                              <h3 className="tg-footer-widget-title mb-25">Get In Touch</h3>
                              <form className="tg-footer-contact-form" onSubmit={(e) => e.preventDefault()}>
                                 <div className="row">
                                    ...
                                    <div className="col-12">
                                       <button type="submit" className="tg-btn tg-btn-yellow w-100">
                                          Send Message
                                       </button>
                                    </div>
                                 </div>
               ...
               <div className="tg-footer-copyright text-center">
                  <span>
                     Copyright <Link to="#">©Hamsafar</Link> |  All Right Reserved
                  </span>
               </div>
            </div>
         </footer>
