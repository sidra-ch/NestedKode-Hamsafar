...
const ResidencesMain: React.FC = () => {
   const residenceServices = services_data.filter(service => service.category === 'Home & Residence');

   return (
      <>
         <Helmet>
            <title>Home & Residence - Afghanistan Tourism</title>
         </Helmet>
         <HeaderOne />
         <main>
            <BreadCrumb 
                  ...
                  <div className="row mb-50">
                     <div className="col-12 text-center">
                        ...
                        <p style={{ 
                           ...
                           Experience authentic Afghan hospitality in our carefully selected guesthouses and apartments. 
