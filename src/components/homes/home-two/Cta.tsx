...
const Cta = () => {
   return (
      <div className="tg-cta-area-area tg-cta-su-2 tg-primary-bg p-relative z-index-1">
         <img className="shape-2 p-absolute d-none d-xl-block" src="/assets/img/cta/su/shape-3.png" alt="" />
               ...
               <div className="col-lg-6 col-md-6">
                  <div className="tg-cta-3-content tg-process-content pt-50 pb-50">
                     ...
                     <div className="tg-cta-3-apps d-flex align-items-center">
                        <Link className="d-inline-block mr-10" to="#"><img src="/assets/img/cta/google.png" alt="" /></Link>
                        <Link className="d-inline-block" to="#"><img src="/assets/img/cta/app.png" alt="" /></Link>
                     </div>
                  </div>
               </div>
               <div className="col-lg-6 col-md-6">
                  <div className="tg-cta-3-thumb p-relative z-index-1 text-end pt-90">
                     <img src="/assets/img/cta/su/thumb.png" alt="" />
                     <img className="shape p-absolute d-none d-xl-block" src="/assets/img/cta/su/shape.png" alt="" />
                  </div>
               </div>
            </div>
         </div>
